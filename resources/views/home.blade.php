    ...
    <div class="bg-light min-vh-100 d-flex align-items-center justify-content-center">
        <div class="container text-center py-5">
            <h1 class="display-4 fw-bold mb-4 text-dark">
                Welcome to <span class="text-warning fw-semibold">We</span><span class="fw-semibold">peka</span> Site</h1>
            ...
            @if(Auth::user())
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('client.headquarters') }}"
                        class="btn btn-dark btn-lg px-4 rounded-pill shadow">Headquarters</a>
                </div>
