...
<style>
    ...
    .info-box h4 {
        font-size: 1.8rem; /* Ukuran H4 diperbesar */
        line-height: 1.3;
        margin-bottom: 25px !important; /* Margin bawah H4 */
    }

    .info-box p {
        font-size: 1.1rem; /* Ukuran paragraf diperbesar */
        line-height: 1.7;
        margin-bottom: 40px !important; /* Margin bawah paragraf */
    }

    .step-list {
        list-style: none;
        padding: 0;
        margin-top: 30px; /* Margin atas list */
    }

    .step-list li {
        margin-bottom: 30px; /* Jarak antar item list diperbesar */
        font-size: 1.05rem; /* Ukuran teks list diperbesar */
        display: flex;
    ...
    .step-list li strong {
        font-size: 1.15rem; /* Teks bold di list lebih besar */
    }

    .step-number {
        background-color: rgba(0,0,0,0.15); /* Warna lebih gelap */
        min-width: 28px; /* Ukuran lingkaran nomor diperbesar */
        height: 28px;
        border-radius: 50%;
        display: flex;
        align-items: center;
        justify-content: center;
        font-size: 14px; /* Ukuran angka di lingkaran */
        font-weight: bold;
        margin-top: 2px;
    }
    ...
    .social-icons-box a {
        display: inline-flex;       /* Agar bisa diatur lebar/tinggi */
        align-items: center;        /* Tengahkan icon secara vertikal */
        justify-content: center;    /* Tengahkan icon secara horizontal */
        width: 60px;                /* Lebar lingkaran */
        height: 60px;               /* Tinggi lingkaran */
        background-color: #FFB619;  /* WARNA LINGKARAN SESUAI REQUEST */
        border-radius: 50%;         /* Membuat bentuk bulat sempurna */
        color: #000;                /* Warna Icon Hitam */
        font-size: 1.8rem;          /* Ukuran Icon */
        margin-right: 20px;         /* Jarak antar lingkaran */
    ...
    .social-icons-box a:hover {
        ...
        filter: brightness(0.9);     /* Sedikit menggelap saat di-hover */
    }
    ...
    .illustration-card img {
        width: 100%;
        height: 100%;
        object-fit: cover; /* Gambar akan di-crop otomatis agar full kotak */
    }
        ...
        <div class="col-lg-5">
            <div class="info-box">
                ...
                <p class="small mb-4 opacity-75">
                    You are one step closer to build your perfect product. Our team is ready to help you achieve your goals.
                </p>

                <ul class="step-list">
                    <li>
                        <div class="step-number">1</div>
                        <div><strong>We'll prepare a proposal</strong><br><span class="small opacity-75">Required scope, timeline and price will be included.</span></div>
                    </li>
                    <li>
                        <div class="step-number">2</div>
                        <div><strong>Together we discuss it</strong><br><span class="small opacity-75">Let's get acquainted and discuss all the possible variants and options.</span></div>
                    </li>
                    <li>
                        <div class="step-number">3</div>
                        <div><strong>Let us help build your product</strong><br><span class="small opacity-75">When the contract is signed, we start working immediately.</span></div>
                    </li>
                </ul>
