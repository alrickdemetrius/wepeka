        ...
        <div class="container text-center fade-in-up fade-delay-1">
            ...
            <div class="d-grid gap-3 col-md-6 mx-auto fade-in-up fade-delay-4">
                <a href="{{ route("client.profile") }}"
                   class="btn btn-light btn-lg rounded-pill py-3 px-5 text-dark fw-semibold shadow fade-in-up fade-delay-4">
                    Profile
                </a>
                <a href="{{ route("client.link.view_link") }}"
                   class="btn btn-light btn-lg rounded-pill py-3 px-5 text-dark fw-semibold shadow fade-in-up fade-delay-5">
                    Link Management
                </a>
            </div>
        </div>
